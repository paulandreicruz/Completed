          ...
          <div className="bg-gray-100 flex rounded-sm shadow-2xl shadow-black max-w-5xl p-5">
            ...
            <div className="w-[100%] p-5">
              ...
              <form
                ...
                className="gap-2 flex flex-col font-bebas space-y-4"
              >
                <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-2">
                  <div>
                    ...
                    {touched.firstname && errors.firstname ? (
                      <div className="text-red-600 font-semibold text-xs absolute tracking-widest">
                        {" "}
                        {errors.firstname}{" "}
                      </div>
                    ) : null}
              ...
              >
                <DialogTitle>
                  <span className="font-bebas font-bold text-3xl tracking-wide">
                    Terms of Use
                  </span>
                </DialogTitle>
                <DialogContent>
                  <div className="space-y-5 mb-5">
                    <strong className="font-bebas">
                      Welcome to Cyclecore!
                    </strong>
                    <p className="font-oswald">
                      These terms and conditions outline the rules and
                      regulations for the use of Cyclecore's Website, located at
                      Cyclecore.com.ph.
                    </p>
                    <p className="font-oswald">
                    ...
                    <p className="font-oswald">
                      ...
                      prevailing law of ph. Any use of the above terminology or
                  ...
                  <div className="font-oswald space-y-5 mb-5">
                    <h1 className="font-bold font-bebas">License</h1>
                    <p>
                      License Unless otherwise stated, Cyclecore and/or its
                      licensors own the intellectual property rights for all
                      material on Cyclecore. All intellectual property rights
                      are reserved. You may access this from Cyclecore for your
                      own personal use subjected to restrictions set in these
                      terms and conditions.
                    </p>
                    <h1 className="font-bold font-bebas">You must not :</h1>
                    <ul>
                      <li>- Republish Cyclecore</li>
                      <li>
                        - Sell, rent or sub-license material from Cyclecore
                      </li>
                      <li>
                    ...
                    <p>
                      Cyclecore reserves the right to monitor all Comments and
                  ...
                  <div className="font-oswald space-y-5">
                    <h1 className="font-bold font-bebas">Disclaimer</h1>
                    <p>
                ...
                <DialogActions>
                  ...
                  >
                    <span className="font-bebas text-lg font-bold tracking-wider">
                      Close
                    </span>
                  </Button>
                </DialogActions>
              ...
              <Dialog open={openDialog2} onClose={() => setOpenDialog2(false)}>
                ...
                <DialogContent>
                  <div className="font-oswald space-y-5 mb-6">
                    <p>
                      ...
                      is collected and recorded by Cyclecore and how we use it.
                    </p>
                    <p>
                    ...
                    <p>
                      ...
                      Cyclecore. This policy is not applicable to any
                  ...
                  <div className="font-oswald space-y-5">
                    <h1 className="font-bold font-bebas">Consent</h1>
                    <p>
                      By using our website, you hereby consent to our Privacy
                      Policy and agree to its terms.
                    </p>

                    <h1 className="font-bold font-bebas">
                    ...
                    <ul>
                      ...
                      <li>
                        ...
                        to the website, and for marketing and promotional
                        purposes
                      </li>
                    ...
                    <h1 className="font-bold font-bebas">Log Files</h1>
                    <p>
                    ...
                    <h1 className="font-bold font-bebas">Contact Us</h1>
                    <p>
