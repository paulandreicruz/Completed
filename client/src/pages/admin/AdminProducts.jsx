                ...
                <tr key={p._id} className="border-b">
                  <td className="p-2">
                    <div className="flex gap-1">
                      ...
                      <div>
                        <div className="font-oswald text-sm">{p.name}</div>
                        <div className="flex items-center gap-1">
                          <InputLabel>
                            <div className="text-[10px] font-oswald">
                              {p._id}
                            </div>
                          </InputLabel>
                  ...
                  <td className="p-2 font-oswald text-sm">{p.category.name}</td>

                  <td className="p-2 font-oswald text-sm">
                    {p.subcategory.name}
                  </td>

                  <td className="p-2 font-oswald text-sm">{p.brand.name}</td>
