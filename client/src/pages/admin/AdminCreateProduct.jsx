            ...
            <Grid item>
              <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  >
                    {categories?.map((c) => (
                      <MenuItem key={c._id} value={c._id}>
                        <span className="font-oswald">{c.name}</span>
                      </MenuItem>
                    ))}
                  </Select>
                </div>
                  ...
                  >
                    {subcategories?.map((s) => (
                      <MenuItem key={s._id} value={s._id}>
                        <span className="font-oswald">{s.name}</span>
                      </MenuItem>
                    ))}
                  </Select>
                </div>
                  ...
                  >
                    {brands?.map((b) => (
                      <MenuItem key={b._id} value={b._id}>
                        <span className="font-oswald">{b.name}</span>
                      </MenuItem>
                    ))}
                  </Select>
                </div>
                ...
                <div>
                  ...
                  >
                    <MenuItem value={10}>
                      <span className="font-oswald">10</span>
                    </MenuItem>

                    <MenuItem value={20}>
                      <span className="font-oswald">20</span>
                    </MenuItem>

                    <MenuItem value={30}>
                      <span className="font-oswald">30</span>
                    </MenuItem>

                    <MenuItem value={40}>
                      <span className="font-oswald">40</span>
                    </MenuItem>

                    <MenuItem value={50}>
                      <span className="font-oswald">50</span>
                    </MenuItem>

                    <MenuItem value={60}>
                      <span className="font-oswald">60</span>
                    </MenuItem>

                    <MenuItem value={70}>
                      <span className="font-oswald">70</span>
                    </MenuItem>

                    <MenuItem value={80}>
                      <span className="font-oswald">80</span>
                    </MenuItem>

                    <MenuItem value={90}>
                      <span className="font-oswald">90</span>
                    </MenuItem>

                    <MenuItem value={100}>
                      <span className="font-oswald">100</span>
                    </MenuItem>
                  </Select>
                </div>
                ...
                <div className="pt-5 ">
                  ...
                  >
                    <MenuItem value="0">
                      <span className="font-oswald">Yes</span>
                    </MenuItem>
                    <MenuItem value="1">
                      <span className="font-oswald">No</span>
                    </MenuItem>
                  </Select>
                </div>
