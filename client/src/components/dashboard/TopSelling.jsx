      ...
      <div className="w-[30rem] shadow-md">
        ...
        <div className="p-4 bg-white">
          <table className="w-full text-left">
            ...
            {topSelling.map((t) => (
              <>
                <tbody key={t._id} className="border-b font-bold">
                  <tr>
                    <td className="flex items-center gap-2 font-oswald text-xs font-medium tracking-normal">
                      <img
                        src={`${
                    ...
                    <td>
                      <div className="flex gap-1 font-oswald text-xs font-medium">
